...
class DatabaseHelper {
  ...
  final String tableName = "shopTable";
  final String columnId = "id";
  final String columnItemName = "itemName";
  final String columnItemDate = "dateCreated";
  ...
  initDb() async {
    Directory documentDyrectory = await getApplicationDocumentsDirectory();
    String path = join(documentDyrectory.path, "shop3_table.db");
  ...
  void _onCreate(Database db, int version) async {
    await db.execute(
      "CREATE TABLE $tableName(id INTEGER PRIMARY KEY , $columnItemName TEXT, $columnItemDate TEXT)"
    );
  }
